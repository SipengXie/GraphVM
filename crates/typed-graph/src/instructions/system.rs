...
impl GasNode {
    pub fn new(gas_ptr: *const U256) -> Self {
        Self { inputs: (gas_ptr,), outputs: (U256::ZERO,) }
    }
}
...
impl AddressNode {
    pub fn new(frame_ptr: *const FrameContext) -> Self {
        Self { inputs: (frame_ptr,), outputs: (U256::ZERO,) }
    }
}
...
pub struct CodecopyNode {
    ...
    inputs: (*const U256, *const U256, *const U256, *const FrameContext, Rc<RefCell<SharedMemory>>),
    /// Outputs: None. Modifies memory.
    _outputs: (),
}

impl HasInputType<(*const U256, *const U256, *const U256, *const FrameContext, Rc<RefCell<SharedMemory>>)> for CodecopyNode {}
...
impl CodecopyNode {
    pub fn new(
        ...
        Self { inputs: (mem_offset_ptr, code_offset_ptr, len_ptr, frame_ptr, memory), _outputs: () }
    }
}
    ...
    fn execute(&mut self) -> anyhow::Result<()> {
        unsafe {
            ...
            if code_offset < code.len() {
                 ...
                 data_to_copy[..copy_len].copy_from_slice(&code[code_offset..code_offset + copy_len]);
            }
...
impl CalldataloadNode {
    pub fn new(offset_ptr: *const U256, frame_ptr: *const FrameContext) -> Self {
        Self { inputs: (offset_ptr, frame_ptr), outputs: (U256::ZERO,) }
    }
}
...
impl HasInputType<(*const U256, *const U256, *const U256, *const FrameContext, Rc<RefCell<SharedMemory>>)> for CalldatacopyNode {}
...
impl CalldatacopyNode {
    pub fn new(
        ...
        Self { inputs: (mem_offset_ptr, data_offset_ptr, len_ptr, frame_ptr, memory), _outputs: () }
    }
}
    ...
    fn execute(&mut self) -> anyhow::Result<()> {
        unsafe {
            ...
            if data_offset < call_data.len() {
                 ...
                 data_to_copy[..copy_len].copy_from_slice(&call_data[data_offset..data_offset + copy_len]);
            }
            // else: data_to_copy remains all zeros
...
impl ReturndatasizeNode {
    ...
    pub fn new(return_data_ptr: *const Bytes) -> Self {
        Self { inputs: (return_data_ptr,), outputs: (U256::ZERO,) }
    }
}
...
pub struct ReturndatacopyNode {
    ...
    /// 4: Rc<RefCell<SharedMemory>> - Shared memory reference.
    inputs: (*const U256, *const U256, *const U256, *const Bytes, Rc<RefCell<SharedMemory>>),
    /// Outputs: None. Modifies memory.
    _outputs: (),
}

impl HasInputType<(*const U256, *const U256, *const U256, *const Bytes, Rc<RefCell<SharedMemory>>)> for ReturndatacopyNode {}
...
impl ReturndatacopyNode {
    pub fn new(
        ...
        Self { inputs: (mem_offset_ptr, data_offset_ptr, len_ptr, return_data_ptr, memory), _outputs: () }
    }
}
        ...
        unsafe {
            ...
            let mut data_to_copy = vec![0u8; len];
             if data_offset < return_data.len() {
                ...
                data_to_copy[..copy_len].copy_from_slice(&return_data[data_offset..data_offset + copy_len]);
            }
            // else: data_to_copy remains all zeros
...
impl Keccak256Node {
    pub fn new(
        ...
        Self { inputs: (offset_ptr, len_ptr, memory), outputs: (U256::ZERO,) }
    }
}

...
//                 match output {
//                     SSAOutput::CallInput(input) => Some(input.clone()),
//                     _ => None
//                 }
//             })
//         })? {
...
//             results.iter().find_map(|output| {
//                 match output {
//                     SSAOutput::CreateInput(input) => Some(input.clone()),
//                     _ => None
//                 }
//             })
//         })? {
...
//     /// 
//     /// # Returns
//     /// * `Result<SSAOutput>` - The resolved contract entry output
